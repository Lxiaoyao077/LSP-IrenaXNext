...
public class HomeFragment extends BaseFragment implements MenuProvider {
    ...
    private void updateStates(Activity activity, boolean binderAlive) {
        if (binderAlive) {
            ...
            binding.statusSummary.setText(String.format(LocaleDelegate.getDefaultLocale(), "%s (%d) - Irena-XNext",
    ...
    public static class AboutDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            binding.designAboutInfo.setText(HtmlCompat.fromHtml(getString(
                    ...
                    "<b><a href=\"https://github.com/silvzr/LSP-IrenaX\">GitHub</a></b>"), HtmlCompat.FROM_HTML_MODE_LEGACY));
